#乃木坂/tiket
[
  ['齋藤飛鳥','写真集','新品、未使用',2380,1,309,63,11 ],
  ['与田優希','写真集','新品、未使用',2380,1,309,63,11 ],
  ['秋本真夏','写真集','新品、未使用',2380,1,309,63,11 ],
  ['衛藤美彩','写真集','新品、未使用',2380,1,309,63,11 ],
  ['橋本奈々美','写真集','新品、未使用',2380,1,309,63,11 ],
  ['橋本奈々美','写真集2','新品、未使用',2380,1,309,63,11 ],
  ['堀未央奈','写真集','新品、未使用',2380,1,309,63,11 ],
  ['堀未央奈','写真集2','新品、未使用',2380,1,309,63,11 ],
  ['星野みなみ','写真集','新品、未使用',2380,1,309,63,11 ],
  ['深川麻衣','写真集','新品、未使用',2380,1,309,63,11 ],
  ['生駒里奈','写真集','新品、未使用',2380,1,309,63,11 ],
  ['生田絵梨花','写真集','新品、未使用',2380,1,309,63,11 ],
  ['井上小百合','写真集','新品、未使用',2380,1,309,63, 11],
  ['松村沙友理','写真集','新品、未使用',2380,1,309,63,11 ],
  ['西野七瀬','写真集','新品、未使用',2380,1,309,63,11 ],
  ['西野七瀬','写真集2','新品、未使用',2380,1,309,63 ,11],
  ['桜井玲香','写真集2','新品、未使用',2380,1,309,63,11 ],
  ['新内眞衣','写真集','新品、未使用',2380,1,309,63 ,11],
  ['白石麻衣','写真集','新品、未使用',2380,1,309,63,11 ],
  ['白石麻衣','写真集2','新品、未使用',2380,1,309,63,11 ],
  ['高山一実','写真集','新品、未使用',2380,1,309,63,11 ],
  ['若月佑美','写真集','新品、未使用',2380,1,309,63,11 ],
  ['山下美月','写真集','新品、未使用',2380,1,309,63,11 ],
  ['上坂すみれ','チケット','新品、未使用',6000,1,430,92,11 ],
  ['水樹奈々','チケット','新品、未使用',7200,1,430,92,11 ],
  ['米津','チケット','新品、未使用',2380,1,427,92 ,11],
  ['柿原哲也','チケット','新品、未使用',2380,1,430,92,11 ],
  ['宮野真守','チケット','新品、未使用',2380,1,430,92 ,11],
  ['蒼井翔太','チケット','新品、未使用',2380,1,430,92 ,11],
  ['柿原','チケット','新品、未使用',2380,1,430,92 ,11],
  ['小倉唯','チケット','新品、未使用',2380,1,430,92,11 ],
  ['sumika','チケット','新品、未使用',2380,1,427,92 ,11],
  ['Lisa','チケット','新品、未使用',2380,1,427,92,11 ],
  ['髭男','チケット','新品、未使用',2380,1,427,92,11 ],
].each do |name, state,condition,price,seller_id,category_id,brand_id,root_category_id|
Item.create(
  { name: name, state: state, condition: condition, price: price,seller_id:seller_id,category_id:category_id,brand_id:brand_id,root_category_id:root_category_id}
)
end
